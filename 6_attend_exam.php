...
<div class="container-info">
    ...
    <div class="col-md-8 main" >
        ...
        <div class="col-md-8">
        <div class="card mt-4" style="width: 49rem;background-color: yellow;">
  <div class="card-body">
    ...
    options<br><br>
        ...
        <div class="row"> -->
         ...
         <button type="button" class="btn btn-primary btn-lg btn-block" name="submit_mark">submit mark</button>
         <br>
         ...
         <div class="col-md-4"> 
        <a href="7_score.php?exam_id=<?php echo $E_id;?>" class="btn btn-warning text-center">view score</a>
         </div>
        </div>
        </div> 
