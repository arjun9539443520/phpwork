...
$exe_querry1=mysqli_query($connection,"SELECT * FROM exams");
...
<body>
<div class="container-info primary">
    <div class="row ">
        ...
        ?>
                  ...
                  <label for="">QUESTION:</label>
                    ...
                    <div class="col-md-8">
                        ...
                        <textarea name="question" id="" cols="55" rows="5"></textarea>
                    </div>
                    </div>
                </div> 
                <div class="form-group col-md-12 ">
                  ...
                  <input type="text" class="form-control" id="email" name="option1">
                    </div>
                    </div>
                </div>
                <div class="form-group col-md-12 ">
                  ...
                  <input type="text" class="form-control" id="phone" name="option2">
                    </div>
                    </div>
                </div>
                <div class="form-group col-md-12 ">
                  ...
                  <input type="text" class="form-control" id="password1" name="option3">
                    </div>
                    </div>
                </div>
                <div class="form-group col-md-12 ">
                  ...
                  <input type="text" class="form-control" id="password2" name="option4">
                    </div>
                    </div>
                </div>
                <div class="form-group col-md-12 ">
                  ...
                  <label for="">correct option:</label>
                    ...
                    <div class="col-md-8">
                        <span id="passwordsp2"></span>
                  <input type="text" class="form-control" id="password2" name="ct_option">
                    </div>
                    </div>
                </div>
